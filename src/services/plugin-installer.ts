...
// ⚡ Bolt: Cache the Promise itself rather than the resolved value to prevent redundant
// concurrent system calls when detectPackageManager is called multiple times simultaneously.
