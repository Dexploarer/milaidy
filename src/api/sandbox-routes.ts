...
function performType(text: string): void {
  ...
  if (os === "darwin") {
    ...
    // 🛡️ Sentinel: Prevent command injection by base64 encoding arbitrary user input
    // Decoded natively in PowerShell to safely construct the string without escaping flaws
