...
function performType(text: string): void {
  ...
  if (os === "darwin") {
    ...
    runCommand(
      ...
      [
        "-Command",
        `Add-Type -AssemblyName System.Windows.Forms; $txt = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('${base64Text}')); [System.Windows.Forms.SendKeys]::SendWait($txt)`,
      ],
      10000,
    );
  }
...
function performKeypress(keys: string): void {
  ...
  if (os === "darwin") {
    ...
    runCommand(
      ...
      [
        "-Command",
        `Add-Type -AssemblyName System.Windows.Forms; $k = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('${base64Keys}')); [System.Windows.Forms.SendKeys]::SendWait($k)`,
      ],
      5000,
    );
  }
