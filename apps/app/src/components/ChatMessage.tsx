 ...
 * Wrapping ChatMessage in React.memo prevents unnecessary re-renders of the entire
 * message history when new messages are added to the list or parent state changes.
 * Impact: Significantly reduces React render cycle time on long conversations.
 */
