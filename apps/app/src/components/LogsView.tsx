...
/**
 * Extracted and memoized LogEntry component.
 * React.memo prevents unnecessary re-renders of the log list when
 * parent state (like the search query) changes, since log entry references
 * remain stable in the filtered array.
 */
const LogEntryItem = React.memo(({ entry }: { entry: LogEntry }) => (
  <div
