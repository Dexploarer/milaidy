      ...
      <div {...backdropProps}>
        <div className="w-full max-w-md border border-border bg-card shadow-lg flex flex-col">
          <div className="flex items-center px-5 py-3 border-b border-border">
            ...
            <button
              type="button"
              className="text-muted hover:text-txt text-lg leading-none px-1 cursor-pointer focus-visible:ring-2"
              onClick={close}
              aria-label="Close"
            >
              &times;
    ...
    <div {...backdropProps}>
      <div className="w-full max-w-lg border border-border bg-card shadow-lg flex flex-col max-h-[85vh]">
        ...
        <div className="px-5 py-4 flex flex-col gap-3 overflow-y-auto">
          {errorMsg && (
            <div className="text-xs text-danger border border-danger px-3 py-2" role="alert">
              {errorMsg}
            </div>
          )}
          ...
          <div>
            <button
              type="button"
              className="text-[11px] font-bold text-muted hover:text-txt cursor-pointer flex items-center gap-1 focus-visible:ring-2"
              onClick={() => setShowLogs(!showLogs)}
              aria-expanded={showLogs}
              aria-controls="logs-textarea"
            >
              <ChevronRight
