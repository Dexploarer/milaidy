...
export function ConversationsSidebar({
  ...
  // Memoize sorted conversations to prevent O(N*logN) re-sorts on every render
  const sortedConversations = useMemo(() => {
    return [...conversations].sort((a, b) => {
      // Use Date.parse instead of new Date().getTime() to avoid object allocation inside the sort loop
