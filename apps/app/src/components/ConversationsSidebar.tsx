...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt: Memoize expensive array clone & sort on a frequently updated context value
  const sortedConversations = useMemo(() => {
    return [...conversations].sort((a, b) => {
      // ⚡ Bolt: Use Date.parse() instead of new Date().getTime() to avoid object allocation during sort
