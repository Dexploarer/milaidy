...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt optimization: Memoize the sorted list to prevent expensive N*logN sorting on every render.
  // We use Date.parse() instead of new Date().getTime() to avoid allocating new Date objects during the sort.
