...
function formatRelativeTime(dateString: string): string {
  // Optimize: Use Date.parse and Date.now to avoid expensive object allocation
...
export function ConversationsSidebar({
  ...
  // Optimize: Memoize conversation sorting and use Date.parse to avoid expensive object allocation
