...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt: Cache sorted conversations to prevent unnecessary recalculations on every render,
  // and use Date.parse() instead of new Date().getTime() to avoid object allocation overhead.
