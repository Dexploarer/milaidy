...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt: Prevent O(N*logN) re-sorts on every render by memoizing the sorted array.
  // Using Date.parse instead of new Date().getTime() avoids expensive object allocation
  // and reduces garbage collection overhead during sorting.
