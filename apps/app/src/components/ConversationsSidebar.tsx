...
export function ConversationsSidebar({
  ...
  // Memoize and use Date.parse to prevent expensive re-parsing and sorting on every render,
  // as frequent minor state changes trigger re-renders in useApp() consumers.
