...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt Optimization: Memoize sorted array to prevent O(N*logN) re-sort on every render.
  // Using Date.parse() instead of new Date().getTime() skips object allocation, reducing GC pressure.
