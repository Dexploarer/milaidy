...
export function ConversationsSidebar({
  ...
  // Memoize sorted conversations to avoid expensive re-sorting on every render.
  // We use Date.parse instead of new Date().getTime() to reduce parsing overhead during renders.
