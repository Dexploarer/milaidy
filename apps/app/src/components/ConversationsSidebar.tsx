...
export function ConversationsSidebar({
  ...
  // Memoize sorted conversations to prevent expensive array duplication and
  // Date parsing on every render when other AppContext values change.
  // Using Date.parse() avoids allocating new Date objects compared to getTime().
