...
export function ConversationsSidebar({
  ...
  // What: Memoize the sorting of conversations.
  // Why: Sorting involves array spread and date parsing. Previously, it executed on every render.
  // Impact: Prevents re-sorting the entire list on every keystroke when renaming a chat (which updates local state).
