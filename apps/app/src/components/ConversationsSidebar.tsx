...
export function ConversationsSidebar({
  ...
  // Performance: Memoize the sorted list of conversations so we don't re-sort
  // the array on every render cycle unless the `conversations` array actually changes.
  // This reduces main thread blocking when the conversations list gets large.
