...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt: Optimize rendering by memoizing the conversation sort to prevent O(N*logN) re-sorts on every render.
  // ⚡ Bolt: Optimize date parsing by replacing expensive new Date(dateString).getTime() with Date.parse().
