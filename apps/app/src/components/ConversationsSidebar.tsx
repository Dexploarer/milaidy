...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt: Optimize rendering by memoizing the sorted conversations array
  // and using Date.parse instead of new Date().getTime() to prevent expensive
  // object allocations and garbage collection overhead during sorting.
