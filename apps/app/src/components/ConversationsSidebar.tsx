                  ...
                  <>
                    ...
                    {confirmDeleteId === conv.id ? (
                      ...
                      <button
                        ...
                        className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity border-none bg-transparent text-muted hover:text-danger hover:bg-destructive-subtle cursor-pointer px-1 py-1 rounded flex-shrink-0 flex items-center justify-center"
                        onClick={(e) => {
                          e.stopPropagation();
