...
export function ConversationsSidebar({
  ...
  // ⚡ Bolt Optimization: Use useMemo to avoid O(N*logN) re-sorts on every render
  // and use Date.parse() instead of new Date().getTime() to prevent expensive object allocations
